...
import org.koitharu.kotatsu.favourites.ui.carousel.FavouritesCarouselFragment
import org.koitharu.kotatsu.history.ui.HistoryListFragment
import org.koitharu.kotatsu.profile.ui.ProfileFragment
...
class MainNavigationDelegate(
	...
	private fun onNavigationItemSelected(@IdRes itemId: Int): Boolean {
		val newFragment = when (itemId) {
			...
			R.id.nav_favorites -> FavouritesCarouselFragment::class.java
			R.id.nav_explore -> ExploreFragment::class.java
			R.id.nav_feed -> ProfileFragment::class.java
	...
	private fun getItemId(fragment: Fragment) = when (fragment) {
		...
		is FavouritesCarouselFragment -> R.id.nav_favorites
		is ExploreFragment -> R.id.nav_explore
		is ProfileFragment -> R.id.nav_feed
	...
	private fun observeSettings(lifecycleOwner: LifecycleOwner) {
		settings.observe()
			...
			.onEach {
				...
				// Profile is always visible, no need to check tracker

...
class RemoteListFragment : MangaListFragment(), FilterCoordinator.Owner {
	...
	override fun onEmptyActionClick() {
		if (filterCoordinator.isFilterApplied) {
			...
			// Show confirmation dialog to remove source
			showRemoveSourceDialog()
		}
	}

	private fun showRemoveSourceDialog() {
		val source = viewModel.source
		AlertDialog.Builder(requireContext())
			.setTitle(R.string.remove_source)
			.setMessage(getString(R.string.remove_source_confirmation, source.getTitle(requireContext())))
